...
<div class="container mt-5">
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4">
      <div class="card shadow-sm border-start border-primary border-4">
        <div class="card-body">
          <h5 class="card-title">💰 Ibyacurujwe</h5>
  ...
  <div class="mt-5">
    ...
    <div class="d-flex flex-wrap gap-3">
      <a href="add_product.php" class="btn btn-success"><i class="bi bi-plus-circle"></i> ➕ Injiza igicuruzwa</a>
      <a href="record_sale.php" class="btn btn-primary">💸 Andika ibyacurujwe</a>
