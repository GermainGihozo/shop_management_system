...
<div class="container mt-5">
  ...
  <form method="POST" class="p-4 bg-white rounded shadow-sm mt-4">
    ...
    <div class="mb-3">
      <label>Ingano y'ibyacurujwe</label>
    ...
    <button type="submit" class="btn btn-success">💾 Injiza igicuruzwa</button>
